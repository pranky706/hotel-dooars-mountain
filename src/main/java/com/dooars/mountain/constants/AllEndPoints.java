...
public class AllEndPoints {
    ...
    public static final String GET_CUSTOMER = "/customer-service/getCustomer";
    public static final String ITEM_SERVICE = "/api/item-service/";
    public static final String GET_MENU = ITEM_SERVICE + "getMenu";
    ...
    public static final String MENU_GROUP_SERVICE = "/api/menu-group-service/";
    ...
    public static final String OFFER_SERVICE = "/api/offer-service/";
    ...
    public static final String FILE_SERVICE = "/api/file-service/";
